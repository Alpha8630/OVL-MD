...
module.exports = {
  ...
  NOM_OWNER: process.env.NOM_OWNER || "Eldji",
  NUMERO_OWNER: process.env.NUMERO_OWNER |224622503739| "",
  MODE: process.env.MODE || "public",
  MENU: process.env.MENU || "https://i.ibb.co/ynx9QcZ/image.jpg",
  SESSION_ID: process.env.SESSION_ID || "Ovl-MD_m4AX0f0L",
  ...
  ANTIDELETE: process.env.ANTIDELETE || "oio",
